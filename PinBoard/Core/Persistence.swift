...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        sampleNote.body = "This is your first sticky note! You can pin it to see it on your lock screen."
        sampleNote.icon = "star.fill"
        sampleNote.color = "blue"
        sampleNote.fontSize = "medium"
        sampleNote.isPinned = false
    ...
    init(inMemory: Bool = false) {
        container = NSPersistentContainer(name: "PinBoard")
        if inMemory {
